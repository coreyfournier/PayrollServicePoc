...
An event-driven microservices proof of concept built with C# ASP.NET Core, demonstrating Domain-Driven Design with Kafka event streaming, materialized views, Dapr (outbox + message stream), MongoDB/MySQL persistence, and real-time GraphQL subscriptions.
