...
public static class ServiceEndpoints
{
    ...
    public static string TransferApi => Environment.GetEnvironmentVariable("TRANSFER_API_URL") ?? "http://localhost:5002";
    ...
    public static string MongoTransferDatabaseName => "transfer_db";
